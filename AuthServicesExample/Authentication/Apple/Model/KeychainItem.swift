...
// ADAPTED FROM SOURCE: https://developer.apple.com/documentation/authenticationservices/implementing_user_authentication_with_sign_in_with_apple
...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: AppleIdentifiers.bundleID, account: userIdentifierKey).readItem()
    ...
    static var currentUserName: String {
        do {
            let storedUserName = try KeychainItem(service: AppleIdentifiers.bundleID, account: userNameKey).readItem()
    ...
    static func deleteUserNameFromKeychain() {
        do {
    ...
    static var currentUserEmail: String {
        do {
            let storedUserEmail = try KeychainItem(service: AppleIdentifiers.bundleID, account: userEmailKey).readItem()
